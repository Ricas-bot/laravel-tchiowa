...
<body>
  ...
  <symbol id="twitter" viewBox="0 0 16 16">
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <img src="/img/logo.png" alt="" width="55" height="42" class="img-fluid">
      </a>
    ...
    <footer class="py-5">
      <div class="row">
        <div class="col-2">
          ...
          <li><a href="#" class="nav-link p-0 text-muted scrollto">Home</a></li>
          <li><a href="#about" class="nav-link p-0 text-muted scrollto">Sobre</a></li>
          <li><a href="#service" class="nav-link p-0 text-muted scrollto">Serviços</a></li>
          <li><a href="#portfolio" class="nav-link p-0 text-muted scrollto">Portfólio</a></li>
          <li><a href="#contact" class="nav-link p-0 text-muted scrollto">Contacto</a></li>
          </ul>
        </div>
        ...
        <div class="col-2">
          ...
          <ul class="nav flex-column">
          <li><a href="#service" class="nav-link p-0 text-muted scrollto">Desenvolvimento web e mobile</a></li>
          <li><a href="#service" class="nav-link p-0 text-muted scrollto">Robotic Process Automation</a></li>
          <li><a href="#service" class="nav-link p-0 text-muted scrollto">CCTV/ Serviços de Redes</a></li>
          <li><a href="#service" class="nav-link p-0 text-muted scrollto">Outros Serviços</a></li>
          <li><a href="#service" class="nav-link p-0 text-muted scrollto">Contacto</a></li>
          </ul>
        </div>

        <div class="col-4 offset-1">
          <form>
            <h5>Subscreve o nosso newsletter</h5>
            ...
            <div class="d-flex w-100 gap-2">
              ...
              <button class="btn btn-primary" type="button" id="btnfooter">Subscreve</button>
            </div>
          </form>
        </div>
      </div>
